...
function Adab() {
  ...
  return (
    <div>
      <div>
        <p className="font-1 mb-3 scale-up title">Adab Walimah</p>
      </div>
              ...
              <div className="center" style={{ minWidth: "80px" }}>
                {item.iconAlt ? (
                  <div className="center">
                    <div className="scale-up title flex" style={{ width: "64px" }}>
                  ...
                  <Icon size={1} path={item.icon} className="mr-0-5 scale-up title" />
                )}
              </div>
