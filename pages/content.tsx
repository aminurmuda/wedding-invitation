...
const Content: NextPage<ContentProps> = ({brideNickName, groomNickName}: ContentProps) => {
  ...
  return (
    <div>
      <Head>
        <title>{page.label} | {brideNickName} & {groomNickName} Wedding</title>
        <meta
          name="description"
          content={`E-Invitation for ${brideNickName} & ${groomNickName} Wedding, build with ❤ by aminurmuda`}
        />
